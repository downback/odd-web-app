...
const UpdatesDetail: React.FC<UpdatesDetailProps> = ({ update, isLoading }) => {
  ...
  return (
    <div className="w-full h-fit flex flex-col justify-start lg:justify-center items-center p-6">
      ...
      <div className="w-full md:w-5/6 h-fit relative mb-4 rounded overflow-hidden flex justify-center items-center">
        <Image
          src={update.imageUrl}
          alt={update.title}
          width={500}
      ...
      <p className="w-full md:w-5/6 text-gray-700 whitespace-pre-line text-center">
        {update.description}
      </p>
    </div>
  )
