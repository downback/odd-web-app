  ...
  return (
    <div className="h-full">
      ...
      <div
        ref={textRef}
        lang="en"
        className=" absolute top-10 left-0 font-bold text-5xl md:text-7xl w-full h-6/7 flex flex-col justify-center items-center"
      >
