      ...
      <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
        ...
        >
          <path
            ...
            className="translate-x-10 -translate-y-1/4 md:translate-y-0"
          />
        </svg>
      </div>
      <div
        ref={textRef}
        lang="en"
        className="absolute top-4 md:top-10 left-0 font-bold text-5xl sm:text-6xl xl:text-7xl w-full h-[70vh] md:h-[80vh] flex flex-col justify-center items-center"
      >
        ...
        <div className="w-full h-fit flex-1 flex justify-center items-center">
          <div ref={introTextRef} className="">
            <div className="text-center text-lg md:text-xl xl:text-2xl w-full font-normal">
              ...
              <div>{landingTranslation.introTextBottom}</div>
            </div>
          </div>
        </div>
        <div ref={arrowRef} className="absolute -bottom-32 md:-bottom-20">
