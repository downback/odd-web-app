    ...
    <div className="">
      ...
      >
        <div className="w-9/10 md:w-4/5 lg:w-3/5 h-max overflow-hidden">
          ...
          {/* <div className="h-24 block md:hidden bg-amber-200">
            <div className="">JOURNEY</div>
            <div className="">EASIER</div>
          </div> */}
