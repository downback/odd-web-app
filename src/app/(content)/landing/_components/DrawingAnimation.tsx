...
const AnimatedMotionDrawing: React.FC = () => {
  ...
  return (
    <div className="h-full">
      <div className="absolute top-0 left-0 w-full h-4/5 md:h-5/6 flex flex-col justify-center items-center">
        {/* <svg
          width="100%"
          height="800"
          viewBox="0 0 800 800"
